"""quantumready CLI."""
import argparse, sys
from quantumready.core import scan_path, to_json, readiness, TOOL_NAME, TOOL_VERSION
def main(argv=None) -> int:
    ...
    s = sub.add_parser("scan"); s.add_argument("target"); s.add_argument("--format", choices=["table","json"], default="table")
